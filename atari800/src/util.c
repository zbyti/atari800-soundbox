...
/* 16 bit mixing */
void Util_mix16(SWORD *dst, SWORD *src, unsigned int sndn, int volume, 
		unsigned int dst_step, unsigned int dst_offset, 
		unsigned int src_step, unsigned int src_offset)
{
	SWORD s1, s2;
	int val;
...
/* 8 bit mixing */
void Util_mix8(UBYTE *dst, SWORD *src, unsigned int sndn, int volume,
		unsigned int dst_step, unsigned int dst_offset, 
		unsigned int src_step, unsigned int src_offset)
{
	SWORD s1, s2;
...
void Util_mix(void *dst, SWORD *src, unsigned int sndn, int volume, int bit16,
		unsigned int dst_step, unsigned int dst_offset, 
		unsigned int src_step, unsigned int src_offset)
{
	if (bit16)
		Util_mix16((SWORD *)dst, src, sndn, volume, dst_step, dst_offset, src_step, src_offset);
	else
		Util_mix8((UBYTE *)dst, src, sndn, volume, dst_step, dst_offset, src_step, src_offset);
}
