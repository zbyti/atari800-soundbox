...
extern UBYTE POKEY_SKCTL[POKEY_MAXPOKEYS];
extern UBYTE POKEY_SKSTAT[POKEY_MAXPOKEYS];
extern UBYTE POKEY_IRQST[POKEY_MAXPOKEYS];
extern UBYTE POKEY_IRQEN[POKEY_MAXPOKEYS];
...
extern double POKEY_clock_freq;
