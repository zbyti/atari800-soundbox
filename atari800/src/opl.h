...
typedef struct operator_struct {
	...
	int/*bool*/ sus_keep;					/* keep sustain level when decay finished */
	int/*bool*/ vibrato,tremolo;			/* vibrato/tremolo enable bits */
...
#if defined(OPLTYPE_IS_OPL3)
	int/*bool*/ is_4op,is_4op_attached;	/* base of a 4op channel/part of a 4op channel */
