...
static int SoundSettings(void)
{
...
#ifdef SLIGHTSID
	static UI_tMenuItem slightsid_version_menu_array[] = {
		UI_MENU_ACTION(SLIGHTSID_NO, "No"),
		UI_MENU_ACTION(SLIGHTSID_MONO, "Mono"),
		UI_MENU_ACTION(SLIGHTSID_STEREO, "Stereo"),
		UI_MENU_END
	};
#endif
#ifdef EVIE
	static UI_tMenuItem evie_version_menu_array[] = {
		UI_MENU_ACTION(EVIE_NO, "No"),
		UI_MENU_ACTION(EVIE_1_0, "1.0"),
		UI_MENU_ACTION(EVIE_2_0, "2.0"),
		UI_MENU_END
	};
#endif
#ifdef SIDARI
	static UI_tMenuItem sidari_version_menu_array[] = {
		UI_MENU_ACTION(SIDARI_NO, "No"),
		UI_MENU_ACTION(SIDARI_MONO, "Mono"),
		UI_MENU_ACTION(SIDARI_STEREO, "Stereo"),
		UI_MENU_END
	};
	static UI_tMenuItem sidari_slot_menu_array[] = {
		UI_MENU_ACTION(SIDARI_SLOT_0, "0: $D500-$D51F"),
		UI_MENU_ACTION(SIDARI_SLOT_1, "1: $D520-$D53F"),
		UI_MENU_ACTION(SIDARI_SLOT_2, "2: $D540-$D55F"),
		UI_MENU_ACTION(SIDARI_SLOT_3, "3: $D560-$D57F"),
		UI_MENU_ACTION(SIDARI_SLOT_4, "4: $D580-$D59F"),
		UI_MENU_ACTION(SIDARI_SLOT_5, "5: $D5A0-$D5BF"),
		UI_MENU_ACTION(SIDARI_SLOT_6, "6: $D5C0-$D5DF"),
		UI_MENU_ACTION(SIDARI_SLOT_7, "7: $D5E0-$D5FF"),
		UI_MENU_END
	};
#endif
#ifdef SONARI
	static UI_tMenuItem sonari_version_menu_array[] = {
		UI_MENU_ACTION(SONARI_NO, "No"),
		UI_MENU_ACTION(SONARI_MONO, "One Chip"),
		UI_MENU_ACTION(SONARI_STEREO, "Two Chip"),
		UI_MENU_END
	};
	static UI_tMenuItem sonari_chip_menu_array[] = {
		UI_MENU_ACTION(SONARI_CHIP_NO, "No"),
		UI_MENU_ACTION(SONARI_CHIP_AY, "AY-3-8910"),
		UI_MENU_ACTION(SONARI_CHIP_YM, "YM-2149"),
		UI_MENU_END
	};
	static UI_tMenuItem sonari_slot_menu_array[] = {
		UI_MENU_ACTION(SONARI_SLOT_0, "0: $D500-$D51F"),
		UI_MENU_ACTION(SONARI_SLOT_1, "1: $D520-$D53F"),
		UI_MENU_ACTION(SONARI_SLOT_2, "2: $D540-$D55F"),
		UI_MENU_ACTION(SONARI_SLOT_3, "3: $D560-$D57F"),
		UI_MENU_ACTION(SONARI_SLOT_4, "4: $D580-$D59F"),
		UI_MENU_ACTION(SONARI_SLOT_5, "5: $D5A0-$D5BF"),
		UI_MENU_ACTION(SONARI_SLOT_6, "6: $D5C0-$D5DF"),
		UI_MENU_ACTION(SONARI_SLOT_7, "7: $D5E0-$D5FF"),
		UI_MENU_END
	};
#endif
#if defined(SLIGHTSID) || defined(EVIE) || defined(SIDARI)
	static UI_tMenuItem resid_resample_method_menu_array[] = {
		UI_MENU_ACTION(RESID_SYNTHESIS_METHOD_RESAMPLE_INTERPOLATE, "Interpolate Resample"),
		UI_MENU_ACTION(RESID_SYNTHESIS_METHOD_RESAMPLE_FAST, "Fast Resample"),
		UI_MENU_ACTION(RESID_SYNTHESIS_METHOD_INTERPOLATE, "Interpolate"),
		UI_MENU_ACTION(RESID_SYNTHESIS_METHOD_FAST, "Fast"),
		UI_MENU_END
	};
#endif
#ifdef YAMARI
	static UI_tMenuItem yamari_slot_menu_array[] = {
		UI_MENU_ACTION(YAMARI_SLOT_0, "0: $D500-$D51F"),
		UI_MENU_ACTION(YAMARI_SLOT_1, "1: $D520-$D53F"),
		UI_MENU_ACTION(YAMARI_SLOT_2, "2: $D540-$D55F"),
		UI_MENU_ACTION(YAMARI_SLOT_3, "3: $D560-$D57F"),
		UI_MENU_ACTION(YAMARI_SLOT_4, "4: $D580-$D59F"),
		UI_MENU_ACTION(YAMARI_SLOT_5, "5: $D5A0-$D5BF"),
		UI_MENU_ACTION(YAMARI_SLOT_6, "6: $D5C0-$D5DF"),
		UI_MENU_ACTION(YAMARI_SLOT_7, "7: $D5E0-$D5FF"),
		UI_MENU_END
	};
#endif
#ifdef MELODY_PSG
	static UI_tMenuItem melody_psg_chip_menu_array[] = {
		UI_MENU_ACTION(MELODY_PSG_CHIP_NO, "No"),
		UI_MENU_ACTION(MELODY_PSG_CHIP_AY, "AY-3-8910"),
		UI_MENU_ACTION(MELODY_PSG_CHIP_YM, "YM-2149"),
		UI_MENU_END
	};
#endif
...
#ifdef SLIGHTSID
		UI_MENU_SUBMENU_SUFFIX(10, "Slight SID:", NULL),
#endif
#ifdef EVIE
		UI_MENU_SUBMENU_SUFFIX(11, "Evie:", NULL),
		UI_MENU_ACTION(12, "COVOX page:"),
#endif
#ifdef SIDARI
		UI_MENU_SUBMENU_SUFFIX(13, "SIDari:", NULL),
#endif
#if defined(SLIGHTSID) || defined(EVIE) || defined(SIDARI)
		UI_MENU_SUBMENU_SUFFIX(14, "SID synthesis:", NULL),
#endif
#ifdef SIDARI
		UI_MENU_SUBMENU_SUFFIX(15, "SIDari slot:", NULL),
#endif
#ifdef SONARI
		UI_MENU_SUBMENU_SUFFIX(16, "SONari:", NULL),
		UI_MENU_SUBMENU_SUFFIX(17, "PSG chip 1:", NULL),
		UI_MENU_SUBMENU_SUFFIX(18, "PSG chip 2:", NULL),
		UI_MENU_SUBMENU_SUFFIX(19, "SONari slot:", NULL),
#endif
#ifdef YAMARI
		UI_MENU_ACTION(20, "YAMari:"),
		UI_MENU_SUBMENU_SUFFIX(21, "YAMari slot:", NULL),
#endif
#ifdef MELODY_PSG
		UI_MENU_ACTION(22, "Melody PSG:"),
		UI_MENU_SUBMENU_SUFFIX(23, "PSG chip 1:", NULL),
		UI_MENU_SUBMENU_SUFFIX(24, "PSG chip 2:", NULL),
#endif
		UI_MENU_END
	};
	...
	for (;;) {
...
#ifdef SLIGHTSID
		FindMenuItem(menu_array, 10)->suffix = FindMenuItem(slightsid_version_menu_array, SLIGHTSID_version)->item;
#endif
#ifdef EVIE
		FindMenuItem(menu_array, 11)->suffix = FindMenuItem(evie_version_menu_array, EVIE_version)->item;
		if (EVIE_version != EVIE_NO)
			FindMenuItem(menu_array, 12)->suffix =
				EVIE_covox_page == EVIE_COVOX_D7 ? "D7" :
				/*EVIE_covox_page == EVIE_COVOX_D6 ?*/ "D6" /*: ""*/;
		else
			FindMenuItem(menu_array, 12)->suffix = "N/A";
#endif
#ifdef SIDARI
		FindMenuItem(menu_array, 13)->suffix = FindMenuItem(sidari_version_menu_array, SIDARI_version)->item;
#endif
#if defined(SLIGHTSID) || defined(EVIE) || defined(SIDARI)
		if (FALSE 
#ifdef SLIGHTSID
			|| (SLIGHTSID_version != SLIGHTSID_NO)
#endif
#ifdef EVIE
			|| (EVIE_version != EVIE_NO)
#endif
#ifdef SIDARI
			|| (SIDARI_version != SIDARI_NO)
#endif
		   )
			FindMenuItem(menu_array, 14)->suffix = FindMenuItem(resid_resample_method_menu_array, RESID_resample_method)->item;
		else
			FindMenuItem(menu_array, 14)->suffix = "N/A";
#endif /* defined(SLIGHTSID) || defined(EVIE) || defined(SIDARI) */
#ifdef SIDARI
		if (SIDARI_version != SIDARI_NO)
			FindMenuItem(menu_array, 15)->suffix = FindMenuItem(sidari_slot_menu_array, SIDARI_slot)->item;
		else
			FindMenuItem(menu_array, 15)->suffix = "N/A";
#endif
#ifdef SONARI
		FindMenuItem(menu_array, 16)->suffix = FindMenuItem(sonari_version_menu_array, SONARI_version)->item;
		if (SONARI_version != SONARI_NO)
			FindMenuItem(menu_array, 17)->suffix = FindMenuItem(sonari_chip_menu_array, SONARI_model)->item;
		else
			FindMenuItem(menu_array, 17)->suffix = "N/A";
		if (SONARI_version == SONARI_STEREO)
			FindMenuItem(menu_array, 18)->suffix = FindMenuItem(sonari_chip_menu_array, SONARI_model2)->item;
		else
			FindMenuItem(menu_array, 18)->suffix = "N/A";
		if (SONARI_version != SONARI_NO)
			FindMenuItem(menu_array, 19)->suffix = FindMenuItem(sonari_slot_menu_array, SONARI_slot)->item;
		else
			FindMenuItem(menu_array, 19)->suffix = "N/A";
#endif
#ifdef YAMARI
		SetItemChecked(menu_array, 20, YAMARI_enable);
		if (YAMARI_enable)
			FindMenuItem(menu_array, 21)->suffix = FindMenuItem(yamari_slot_menu_array, YAMARI_slot)->item;
		else
			FindMenuItem(menu_array, 21)->suffix = "N/A";
#endif
#ifdef MELODY_PSG
		SetItemChecked(menu_array, 22, MELODY_PSG_enable);
		if (MELODY_PSG_enable) {
			FindMenuItem(menu_array, 23)->suffix = FindMenuItem(melody_psg_chip_menu_array, MELODY_PSG_model)->item;
			FindMenuItem(menu_array, 24)->suffix = FindMenuItem(melody_psg_chip_menu_array, MELODY_PSG_model2)->item;
		}
		else {
			FindMenuItem(menu_array, 23)->suffix = "N/A";
			FindMenuItem(menu_array, 24)->suffix = "N/A";
		}
#endif
		...
		case 10:
			{
				int option2 = UI_driver->fSelect(NULL, UI_SELECT_POPUP, SLIGHTSID_version, slightsid_version_menu_array, NULL);
				if (option2 >= 0) {
					SLIGHTSID_version = option2;
					SLIGHTSID_Init(POKEYSND_FREQ_17_EXACT, POKEYSND_playback_freq, POKEYSND_num_pokeys, (POKEYSND_snd_flags & POKEYSND_BIT16));
				}
			}
			break;
#endif
		...
		case 11:
			{
				int option2 = UI_driver->fSelect(NULL, UI_SELECT_POPUP, EVIE_version, evie_version_menu_array, NULL);
				if (option2 >= 0) {
					EVIE_version = option2;
					EVIE_Init(POKEYSND_FREQ_17_EXACT, POKEYSND_playback_freq, POKEYSND_num_pokeys, (POKEYSND_snd_flags & POKEYSND_BIT16));
				}
			}
			break;
		case 12:
			if (EVIE_version != EVIE_NO) {
				EVIE_covox_page ^= EVIE_COVOX_D6 ^ EVIE_COVOX_D7;
			}
			break;
#endif
#ifdef SIDARI
		case 13:
			{
				int option2 = UI_driver->fSelect(NULL, UI_SELECT_POPUP, SIDARI_version, sidari_version_menu_array, NULL);
				if (option2 >= 0) {
					SIDARI_version = option2;
					SIDARI_Init(POKEYSND_FREQ_17_EXACT, POKEYSND_playback_freq, POKEYSND_num_pokeys, (POKEYSND_snd_flags & POKEYSND_BIT16));
				}
			}
			break;
#endif
		...
		case 14:
			if (FALSE
				...
				int option2 = UI_driver->fSelect(NULL, UI_SELECT_POPUP, RESID_resample_method, resid_resample_method_menu_array, NULL);
				if (option2 >= 0) {
					RESID_resample_method = option2;
#ifdef SLIGHTSID
					SLIGHTSID_Reinit(POKEYSND_playback_freq);
#endif
#ifdef EVIE
					EVIE_Reinit(POKEYSND_playback_freq);
#endif
#ifdef SIDARI
					SIDARI_Reinit(POKEYSND_playback_freq);
#endif
				}
			}
			break;
		...
		case 15:
			{
				if (SIDARI_version != SIDARI_NO) {
					int option2 = UI_driver->fSelect(NULL, UI_SELECT_POPUP, SIDARI_slot, sidari_slot_menu_array, NULL);
					if (option2 >= 0) {
						SIDARI_slot = option2;
						SIDARI_Init(POKEYSND_FREQ_17_EXACT, POKEYSND_playback_freq, POKEYSND_num_pokeys, (POKEYSND_snd_flags & POKEYSND_BIT16));
					}
		...
		case 16:
			{
				int option2 = UI_driver->fSelect(NULL, UI_SELECT_POPUP, SONARI_version, sonari_version_menu_array, NULL);
				if (option2 >= 0) {
					SONARI_version = option2;
					SONARI_Init(POKEYSND_FREQ_17_EXACT, POKEYSND_playback_freq, POKEYSND_num_pokeys, (POKEYSND_snd_flags & POKEYSND_BIT16));
				}
			}
			break;
		case 17:
			{
				if (SONARI_version != SONARI_NO) {
					int option2 = UI_driver->fSelect(NULL, UI_SELECT_POPUP, SONARI_model, sonari_chip_menu_array, NULL);
					if (option2 >= 0) {
						SONARI_model = option2;
						SONARI_Init(POKEYSND_FREQ_17_EXACT, POKEYSND_playback_freq, POKEYSND_num_pokeys, (POKEYSND_snd_flags & POKEYSND_BIT16));
					}
				}
			}
		...
		case 18:
			{
				if (SONARI_version == SONARI_STEREO) {
					int option2 = UI_driver->fSelect(NULL, UI_SELECT_POPUP, SONARI_model2, sonari_chip_menu_array, NULL);
					if (option2 >= 0) {
						SONARI_model2 = option2;
						SONARI_Init(POKEYSND_FREQ_17_EXACT, POKEYSND_playback_freq, POKEYSND_num_pokeys, (POKEYSND_snd_flags & POKEYSND_BIT16));
					}
				}
			}
		...
		case 19:
			{
				if (SONARI_version != SONARI_NO) {
					int option2 = UI_driver->fSelect(NULL, UI_SELECT_POPUP, SONARI_slot, sonari_slot_menu_array, NULL);
					if (option2 >= 0) {
						SONARI_slot = option2;
						SONARI_Init(POKEYSND_FREQ_17_EXACT, POKEYSND_playback_freq, POKEYSND_num_pokeys, (POKEYSND_snd_flags & POKEYSND_BIT16));
					}
		...
		case 20:
			{
				YAMARI_enable = !YAMARI_enable;
				YAMARI_Init(POKEYSND_FREQ_17_EXACT, POKEYSND_playback_freq, POKEYSND_num_pokeys, (POKEYSND_snd_flags & POKEYSND_BIT16));
			}
			break;
		case 21:
			{
				if (YAMARI_enable) {
					int option2 = UI_driver->fSelect(NULL, UI_SELECT_POPUP, YAMARI_slot, yamari_slot_menu_array, NULL);
					if (option2 >= 0) {
						YAMARI_slot = option2;
						YAMARI_Init(POKEYSND_FREQ_17_EXACT, POKEYSND_playback_freq, POKEYSND_num_pokeys, (POKEYSND_snd_flags & POKEYSND_BIT16));
					}
		...
		case 22:
			{
				MELODY_PSG_enable = !MELODY_PSG_enable;
				MELODY_PSG_Init(POKEYSND_FREQ_17_EXACT, POKEYSND_playback_freq, POKEYSND_num_pokeys, (POKEYSND_snd_flags & POKEYSND_BIT16));
			}
			break;
		case 23:
			{
				if (MELODY_PSG_enable) {
					int option2 = UI_driver->fSelect(NULL, UI_SELECT_POPUP, MELODY_PSG_model, melody_psg_chip_menu_array, NULL);
					if (option2 >= 0) {
						MELODY_PSG_model = option2;
						MELODY_PSG_Init(POKEYSND_FREQ_17_EXACT, POKEYSND_playback_freq, POKEYSND_num_pokeys, (POKEYSND_snd_flags & POKEYSND_BIT16));
					}
				}
			}
		...
		case 24:
			{
				if (MELODY_PSG_enable) {
					int option2 = UI_driver->fSelect(NULL, UI_SELECT_POPUP, MELODY_PSG_model2, melody_psg_chip_menu_array, NULL);
					if (option2 >= 0) {
						MELODY_PSG_model2 = option2;
						MELODY_PSG_Init(POKEYSND_FREQ_17_EXACT, POKEYSND_playback_freq, POKEYSND_num_pokeys, (POKEYSND_snd_flags & POKEYSND_BIT16));
					}
				}
			}
