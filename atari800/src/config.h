...
/* Define to 1 if you have the `ayemu' library (-layemu). */
#define HAVE_LIBAYEMU 1
...
/* Define to emulate the OPL3 chips. */
#define OPL3_EMU 1
...
#define PACKAGE_STRING "Atari800 4.1.0"
...
/* Define to emulate the AY/YM chips. */
#define PSG_EMU 1
...
/* The SIDari sound card. */
#define SIDARI 1

/* Define to emulate the SID chip. */
#define SID_EMU 1

/* The SlightSID sound card. */
#define SLIGHTSID 1

/* The SONari sound card. */
#define SONARI 1
